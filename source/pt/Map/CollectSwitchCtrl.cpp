...
* 
* Activates the SW_A event when the specified amount of the configured item has been collected. It can check a variety
* of items, such as Coins, Purple Coins, Star Bits and Power Stars.
*/
